          ...
          <div className="flex flex-col gap-2 pb-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex w-full items-center justify-start sm:w-auto sm:justify-end">
              ...
              <div className="flex w-full sm:w-auto">
                ...
                <NavLink to="/">
                  <button className="ml-1 rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-4" onClick={handleHomenavigation}>Home</button>
                </NavLink>
                <NavLink
                  to="/pages/Login"
                ><button className="ml-1 rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-4" >Login</button></NavLink>

                <NavLink
                  to="/pages/Cart">
                  <button className="ml-1 rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-4">Cart</button></NavLink>
              </div>
            </div>
          </div>
          <div>
            <ul>
              <div className="scrollbar-hide flex gap-1 overflow-x-auto px-1 pb-2 sm:px-5">
                ...
                <div onClick={handleBeauty} className="px-2.5 flex flex-col items-center underline:none hover:underline">
                  <img src={nav6} />
                ...
                <div onClick={handlAuto} className="px-2.5 flex flex-col items-center underline:none hover:underline">
                  <img src={nav10} />
