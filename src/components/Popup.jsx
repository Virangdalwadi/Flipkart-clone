      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h2 id="popup-title" className={`wrap-break-words text-lg font-semibold ${style.titleClass}`}>
              {title}
            </h2>
            <p id="popup-message" className="mt-2 wrap-break-words text-sm leading-6 text-gray-600">
              {message}
            </p>
          </div>
          <button
